...
class stackedExample(QWidget):
    def __init__(self):
        ...
        self.initial_load_and_count_csv()
        ...
        # hbox.addWidget(self.save_csv_button)
        # hbox.addWidget(self.open_csv_button)
        # hbox.addWidget(self.extract_values_button)
    ...
    def initial_load_and_count_csv(self):
        global count_list
        global second_column_values
        global zeroth_column_values
        global first_column_values

        file_path = "v3.0.0 - Akash_m2 (1) (2).csv"
        ...
        for item_name in self.item_names:
            ...
            for _ in range(count_list[self.item_names.index(item_name)]):
                ...
                if stack_layout is not None:
                    # Traverse the layout and find QSpinBox widgets
                    for index in range(stack_layout.count()):
                        item_at = stack_layout.itemAt(index)
                        if item_at and isinstance(item_at.widget(), QSpinBox):
